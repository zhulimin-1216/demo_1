...
<body class="w100" style="padding-top: 0px;">
	...
	<div id="app">
		...
		<c:forEach items="${courses}" var="i" varStatus="status">
			<!--面包屑导航-->
			...
			<div class="classify">
				<div class="container" id="dataContainer">
					<div class="section">
						...
						<ul>
							<c:forEach items="${i.videoss}" var="j">
								<li class="section-main" onclick="getVideo(217)">
								<a href="/VideoSSM/videoPlay.do?videoId=${j.videoId}&subjectId=${i.subjectId}"> <div class="thum" style="background-image: url(${j.imageUrl})"></div> </a>
									<p>${j.title}</p>
