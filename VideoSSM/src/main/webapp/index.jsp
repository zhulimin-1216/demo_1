...
<body class="w100" style="padding-top: 0px;">
		...
		<div class="container">
			...
			<div class="course-info">
				<table cellspacing="10">
					<tbody>
						<tr>
							<td colspan="2"><a href="/VideoSSM/courseWithVideoAndSubject.do?subjectId=1"> <img
							...
							<a class="opacity5" href="/VideoSSM/courseWithVideoAndSubject.do?subjectId=2"> <img
						...
						<tr>
							<td><a class="opacity5" href="/VideoSSM/courseWithVideoAndSubject.do?subjectId=5"> <img
							...
							<td colspan="2"><a href="/VideoSSM/courseWithVideoAndSubject.do?subjectId=10"> <img
									src="/VideoSSM/static/z/python.jpg" alt="" class="image scale"
									draggable="false">
									<div class="headline">
						...
						<tr>
							<td colspan="2"><a href="/VideoSSM/courseWithVideoAndSubject.do?subjectId=11"> <img
									src="/VideoSSM/static/z/php.jpg" alt="" class="image scale"
									draggable="false">
									<div class="headline">
	...
	<div class="mask hidden" id="reg">
		<div class="mask_content">
			...
			<div class="mask_content_body">
				<form id="regForm" action="addUser.do">
					<h3>新用户注册</h3>
